...
public class GetUserWithMobileRequestHandler : IRequestHandler<GetUserWithMobileRequest, Result<IEnumerable<UserListResponse>>>
{
    private readonly FormsInfoDbContext _dbContext;
    private readonly GetItems getItems;
    private readonly IValidator<GetUserWithMobileRequest> _validator;
    private readonly IHttpContextAccessor _httpContextAccessor;
    public GetUserWithMobileRequestHandler(FormsInfoDbContext dbContext
        ,IValidator<GetUserWithMobileRequest> validator,
IHttpContextAccessor httpContextAccessor)
    ...
    public async Task<Result<IEnumerable<UserListResponse>>> Handle(GetUserWithMobileRequest request, CancellationToken cancellationToken)
    {
        ...
        var results = await getItems.GetInfoWithMobile(request.Mobile, _dbContext, cancellationToken);
